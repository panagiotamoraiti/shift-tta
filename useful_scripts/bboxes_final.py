...
path = "/home/panagiota/work/tta/processed_data/val_clear_daytime/"

# Save images
val_output_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/Experiments/val/Exp1/images'
json_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/Experiments/val/Exp1/'
json_data_val = read_json_file(json_path + "results.bbox.scalabel.json")
visualize_bboxes_save_images(json_data_val, path, val_output_path)


# Save video
img_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/Experiments/val/Exp1/images'
val_output_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/Experiments/val/Exp1/videos'
images_to_video(json_data_val, img_path, val_output_path)

#########################################


# path = "/home/panagiota/work/tta/processed_data/test_clear_daytime/"
#
# # Save images
# val_output_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/mean_teacher/test_mean_teacher/images'
# json_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/mean_teacher/test_mean_teacher/'
# json_data_val = read_json_file(json_path + "results.bbox.scalabel.json")
# visualize_bboxes_save_images(json_data_val, path, val_output_path)
#
#
# # Save video
# img_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/mean_teacher/test_mean_teacher/images'
# val_output_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/mean_teacher/test_mean_teacher/videos'
# images_to_video(json_data_val, img_path, val_output_path)
