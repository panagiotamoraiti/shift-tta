...
val_path = "/home/panagiota//work/tta/processed_data/val_clear_daytime/"
val_output_path = '/home/panagiota/work/tta/processed_data/visualize_bboxes/no_adaptation_baseline/val_no_adaptation/images'
json_data_val = read_json_file(val_path + "results.bbox.scalabel.json")
