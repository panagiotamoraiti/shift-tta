CONFIG=configs/continuous/dino/no_adap_yolox_dino/yolox_x_8xb4-24e_cityscapes_no_adaptation_dino.py
CKPT=https://dl.cv.ethz.ch/shift/challenge2023/test_time_adaptation/checkpoints/yolox_x_8xb4-24e_shift_clear_daytime.pth
WORK_DIR=work_dirs/continuous/dino/no_adap_yolox_dino/val/yolox_x_8xb4-24e_cityscapes
