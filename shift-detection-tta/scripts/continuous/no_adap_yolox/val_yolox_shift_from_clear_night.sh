CONFIG=configs/continuous/no_adap_yolox/yolox_x_8xb4-24e_shift_from_clear_night.py
CKPT=https://dl.cv.ethz.ch/shift/challenge2023/test_time_adaptation/checkpoints/yolox_x_8xb4-24e_shift_clear_daytime.pth
WORK_DIR=work_dirs/continuous/no_adap_yolox/val/yolox_x_8xb4-24e_shift_from_clear_night
