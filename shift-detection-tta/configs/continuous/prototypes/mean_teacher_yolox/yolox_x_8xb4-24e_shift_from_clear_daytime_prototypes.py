...
model = dict(
    ...
    adapter=dict(
        type='MeanTeacherYOLOXAdapterPrototypes', ### Use Mean Teacher with Contrastive loss
        ...
        teacher=dict(
            ...
            update_buffers=True),
        filter_pseudo_labels=0.7, # 0.7
        loss=dict(
            type='YOLOXConsistencyContrastiveLossProt', ### Define consistency-contrastive loss
